using MyBlog.Core.Common.LogHelper;
using MyBlog.Core.Hubs;
...
namespace MyBlog.Core.Web.AOP
{
    /// <summary>
    /// 拦截器BlogLogAOP 继承IInterceptor接口
    /// </summary>
    public class LuoKiPetLogAOP : IInterceptor
    {
        private readonly IHubContext<ChatHub> _hubContext;
        public LuoKiPetLogAOP(IHubContext<ChatHub> hubContext)
        {
