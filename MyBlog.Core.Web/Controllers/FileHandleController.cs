...
using MyBlog.Core.Common.Models.FileHandleModel;
...
namespace MyBlog.Core.Web.Controllers
{
    ...
    public class FileHandleController : ControllerBase
    {
        ...
        public FileHandleController(ICaching cache)
        {
            _cache = cache;
        }
        /// <summary>
        ...
        /// <returns></returns>
        [HttpPost, Route("RequestUploadFile")]
        ...
        /// <returns></returns>
        [HttpPost,Route("RequestDownloadFile")]
        ...
        public async Task<IActionResult> FileDownload([FromBody]Dictionary<string, object> fileInfo)
        {
            ...
            using (var fs = new FileStream(filePath, FileMode.Open))
            {
                ...
                //fs.Close();
                return File(datas, "application/msword");
            }
        }
